...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langgraph-sdk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langgraph-sdk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langgraph-sdk
# for installing globally
pixi global install langgraph-sdk
```
...
It is possible to list all of the versions of `langgraph-sdk` available on your platform:
...
```
pixi search langgraph-sdk --channel conda-forge
```
